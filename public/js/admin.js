...
accountTypeList.addEventListener("change", function () { 
    ...
    let accountTypeURL = "/inv/getAccounts/"+ account_type
...
function buildAccountList(data) { 
    ...
    data.forEach(function (element) { 
     ...
     dataTable += `<td><a href='/account/update/${element.account_id}' title='Click to update'>Update Account</a></td>`; 
     dataTable += `<td><a href='/inv/delete/${element.account_id}' title='Click to delete'>Delete Account</a></td></tr>`; 
    }) 
    dataTable += '</tbody>'; 
